      ...
      <div className="container mx-auto px-4 py-12 md:py-24">
        <div className="grid md:grid-cols-2 gap-8 items-center">
          ...
          <div className="relative">
            <img 
              src="https://images.unsplash.com/photo-1629976801555-d148fbecccfa" 
              alt="Oscar Digital Weighing Scale" 
              className="rounded-lg shadow-2xl max-w-full h-auto object-cover md:ml-auto"
            />
            
            <div className="absolute -bottom-6 -left-6 md:bottom-12 md:-left-12 bg-white p-4 rounded-lg shadow-lg w-48">
